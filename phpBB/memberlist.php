...
switch ($mode)
{
	...
	case 'contactadmin':
		if ($user_id)
		{
			$route = $controller_helper->route('phpbb_message_user', ['user_id' => $user_id], false);
		}
		else if ($topic_id)
		{
			$route = $controller_helper->route('phpbb_message_topic', ['topic_id' => $topic_id], false);
		}
		else if ($mode === 'contactadmin')
		{
			$route = $controller_helper->route('phpbb_message_admin', [], false);
		}
